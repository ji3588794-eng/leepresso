...
const priceRows = [
  ...
  { name: "커피머신장비", desc: "커피머신, 컵 디스펜서, 제빙기 등(30% 계약금, 36개월 리스)", old: "2200만원", cost: "726만원", badge: "월 550,280원" },
  { name: "인테리어/간판", desc: "내외관 시공 (8평 기준), 간판 시공", cost: "1,200만원", old: null, badge: "자체시공가능" },
  { name: "기타/초도물품(지원)", desc: "가구, 오브제, 소품, 스타일링, 개점 홍보, (테이블/의자 별도)", cost: "200만원~", old: null, badge: "오픈패키지" },
];
    ...
    <section id="price" className="price">
      <div className="container">
        <div className="header">
          <h2>리프레소 창업비용 안내</h2>
          <p className="sub">리프레소의 창업 비용을 확인하세요</p>
          <div className="infoRow">
            <span>* 가맹점매장 8평 기준 적용</span>
        ...
        <div className="totalBox">
          <h3>실투자비용 합계 <span>(프로모션 적용 시)</span></h3>
