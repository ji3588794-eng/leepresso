...
export default function Machine() {
  ...
  const rowDataSecond = [
    {
      cate: "즉각 대응", 
      title: "24시간 긴급 케어 시스템",
      text: "기기 장애 시 전문가가 즉시 출동하는 대응 체계를 갖추어, 비상 상황에도 멈춤 없는 24시간 무인 운영을 지원합니다.",
    },
    {
      cate: "메뉴 개발",
      title: "독보적인 메뉴 구성",
      text: "커피를 넘어선 탄산 에이드, 시그니처 음료까지. 끊임없는 R&D를 통해 객단가를 높이는 메뉴를 제안합니다.",
    },
    {
      cate: "추출 기술",
      title: "정밀 추출 메커니즘",
      text: "단순한 기계를 넘어 최적화된 추출 공학으로 무인 카페에서도 일관된 고품질의 음료를 구현합니다.",
    },
    {
      cate: "원격 관리",
      title: "스마트 원격 제어 시스템",
      text: "매장에 가지 않아도 스마트폰이나 대시보드를 통해 원격으로 기기를 직접 제어할 수 있는 효율적인 관리 환경을 제공합니다.",
    },
  ];
